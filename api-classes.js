...
class StoryList {
  ...
  //  */
  // Once a user has logged in, allow them to create a new story. This will involve adding a new 
  //  form that when submitted will send the data in the form to the API, which will respond with 
  ...
  async addStory(user, newStory) {
    console.log(`User ${user} added story ${newStory}.`)
